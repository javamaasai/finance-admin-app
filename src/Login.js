                ...
                <div style={{ ...styles.main, backgroundColor: primary1Color }}>
                    <Card style={styles.card}>
                        <div style={styles.avatar}>
                            <img style={styles.logoWidth} src={require('./images/fasttransfer-autofinance-logo-02.png')} />
                            <p style={styles.hint}>FAST <span style={styles.hintDark}>TRANSFER</span> <br/>auto finance</p>
                        </div>
